...
superclusters = "GCF_000153205_000000000001_gene_clusters.csv"
genomes = ["GCA_024102725", "SMAGOTU_00516"]
dir_path = os.getcwd()
outputs = []
...
with open(superclusters, 'r') as file:
    ...
    for line in file:
        ...
        if len(cur_acc) > 4:
            ...
            output = [("GCF_000153205_000000000001", start1, stop)]
            ...
            for genome in genomes:
                for file_name in os.listdir(dir_path):
                    if file_name.startswith(genome) and file_name.endswith('.csv'):
                        ...
                        if contig == 'GCF_000153205_000000000001':
                            continue
